    ...
    <section ref={sectionRef} className={styles.wrapper}>
      <div ref={pinContainerRef} className={styles.pinContainer}>
        ...
        <div ref={splitStageRef} className={styles.splitStage}>
          <span ref={wLRef} className={styles.word} style={{ transform: "translate(-100%, -50%)", fontSize: "13vw" }}>Refined</span>
          ...
          <span ref={wRRef} className={styles.word} style={{ transform: "translate(0%, -50%)", fontSize: "13vw" }}>Living</span>
        </div>
